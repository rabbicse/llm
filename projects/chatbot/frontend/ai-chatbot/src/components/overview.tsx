...
import { MessageIcon, OllamaIcon } from '@/components/ui/icons';
        ...
        >
            <div className="rounded-xl p-6 flex flex-col gap-4 leading-relaxed text-center max-w-xl">
                ...
                <p className="gap-1 items-center">
                    This is an open-source AI chatbot built with React 19, Next.js 15, Python, FastAPI, and the Ollama SDK. Learn more at{' '}
                    <Link
